...
#Here in account_url we have to generate SAS key and pass connection string of SAS key 
blob_service = BlobServiceClient(account_url=SAS_KEY)
...
def upload_file():
    if request.method == 'POST':
        ...
        try:
            blob_service.get_blob_client(container=container, blob=filename)
